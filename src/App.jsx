          ...
          <div className="profile-header" style={{display: 'flex', justifyContent: 'space-between', alignItems: 'flex-start', padding: '16px 0'}}>
            <div style={{display: 'flex', gap: '16px', alignItems: 'flex-start'}}>
              ...
              <div style={{display: 'flex', flexDirection: 'column', gap: '8px'}}>
                ...
                <button className="login-action-btn secondary" id="goUserCenterBtn" onClick={() => window.location.href = './usercenter'}>
                  <i className="fas fa-user-gear"></i> 用户中心
                </button>
              </div>
            </div>
          </div>
      ...
      <div className="login-page" id="loginPage">
        <div className="auth-box" id="authBox">
          ...
          <div className="panel pA" id="pA">
            ...
            <p style={{cursor: 'pointer', marginTop: '6px', color: 'var(--primary)', textAlign: 'center', fontSize: '13px'}} onClick={() => window.location.href = './usercenter'}>
              <i className="fas fa-user-gear"></i> 用户中心
            </p>
